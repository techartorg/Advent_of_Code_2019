...
def calculate_fuel_required( input_mass: int ) -> int:
	"""
	The provided algorithm to calculate fuel required based on mass.
	
	Arguments:
		 input_mass {int} -- The mass to be lifted
...
if __name__ == '__main__':
	...
	with Path( '01_input.txt' ).open() as f:
		for module_mass in f:
			...
			additional_fuel: int = module_fuel
	...
	print( f'The total fuel requirement is: {total_fuel}.' )
